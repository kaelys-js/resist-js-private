      ...
      <Sidebar.MenuItem>
        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Content
            class="w-48 rounded-lg bg-white/[0.08] dark:bg-white/[0.06] backdrop-blur-2xl backdrop-saturate-150 border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_1px_rgba(255,255,255,0.1)_inset]"
            side="bottom"
            align="end"
          >
    ...
    <Sidebar.Menu>
      <Sidebar.MenuItem>
        <Popover.Root>
          ...
          <Popover.Content side="right" align="start" class="w-56 rounded-lg p-2">

    ...
    >
      ...
      {#if toolbarOpen && activePanel}
        ...
        >
          <!-- Drag handle -->
          <div
            class="flex items-center justify-center py-1.5 shrink-0 touch-none {dragging
              ? 'cursor-grabbing'
              : 'cursor-grab'}"
        ...
        >
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.featureFlags, 'Feature Flags')}
                shortcutLabel={shortcutStore.format('DEV_FLAGS_PANEL')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.appPreferences, 'App Preferences')}
                shortcutLabel={shortcutStore.format('DEV_APP_PANEL')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.debugSettings, 'Debug Settings')}
                shortcutLabel={shortcutStore.format('DEV_DEBUG_PANEL')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.performance, 'Performance')}
                shortcutLabel={shortcutStore.format('DEV_PERF_PANEL')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={cycleThemeLabel}
                shortcutLabel={shortcutStore.format('DEV_CYCLE_MODE')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.copyStateJson, 'Copy State as JSON')}
                shortcutLabel={shortcutStore.format('DEV_COPY_STATE')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
          ...
          <Tooltip.Root delayDuration={300}>
            ...
            <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
              <TooltipLabel
                label={t(localeStore.t.devToolbar.resetAllDefaults, 'Reset All to Defaults')}
                shortcutLabel={shortcutStore.format('DEV_RESET_ALL')}
              />
            </Tooltip.Content>
          </Tooltip.Root>
        </div>
      ...
      <Tooltip.Root delayDuration={1500}>
        <Tooltip.Trigger>
          {#snippet child({ props }: { props: Record<string, unknown> })}
            <button
              ...
              onpointermove={onDragMove}
              onpointerup={onDragEnd}
              aria-label={toolbarOpen
                ? t(localeStore.t.devToolbar.collapseToolbar, 'Collapse developer toolbar')
                : t(localeStore.t.devToolbar.expandToolbar, 'Expand developer toolbar')}
        ...
        {#if !toolbarOpen}
          <Tooltip.Content side="top" sideOffset={8} class="z-[100000]">
            <TooltipLabel
              label={t(localeStore.t.devToolbar.title, 'Developer Toolbar')}
              shortcutLabel={shortcutStore.format('TOGGLE_DEV_TOOLBAR')}
            />
          </Tooltip.Content>
        {/if}
      </Tooltip.Root>

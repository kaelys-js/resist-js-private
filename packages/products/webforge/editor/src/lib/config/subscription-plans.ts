 ...
 *
 * Plan tiers:
 * - **Free** — 10 flags disabled (no settings, themes, languages, resizable sidebar, project dropdown, shortcuts)
 * - **Starter** — 3 flags disabled (no project dropdown settings, shortcuts, settings in user menu)

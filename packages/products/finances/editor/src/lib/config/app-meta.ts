...
export const APP_NAME: Str = 'Finances';

/** Short name for PWA manifest and home screen. */
export const APP_SHORT_NAME: Str = 'Finances';

/** Marketing tagline shown in meta tags. */
export const APP_TAGLINE: Str = 'Personal Finance Dashboard';

/** App description for PWA manifest and meta tags. */
export const APP_DESCRIPTION: Str = 'Track expenses, income, debt, and lifetime costs';
 ...
 * @returns Prefixed key string (e.g. 'finances:editor-state')
 *
 * @example
 * storageKey('editor-state') // 'finances:editor-state'
 * storageKey('mode')         // 'finances:mode'
 */

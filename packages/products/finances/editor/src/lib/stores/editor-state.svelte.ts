...
/**
 * Creates a new app store, resetting module-level state to defaults
...
/**
 * Initializes the app store singleton. Call once in `+layout.svelte`.
 *
...
/**
 * Returns the app store singleton. Must be called after `initEditorStore()`.
 *
 * @returns The singleton EditorStore instance

...
export const en: LintStrings = {
  ...
  debug: {
    ...
    workspaceToolLoading: 'Loading workspace tool registry',
    workspaceToolResults: 'Workspace tools produced {count} result(s)',
    workspaceToolRunning: 'Running {toolCount} workspace tools',

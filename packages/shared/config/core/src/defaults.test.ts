...
describe('defaults', () => {
  ...
  it('versions defaults are correct', () => {
    ...
    expect(Object.keys(defaults.versions.nodeTools).length).toBe(36);
    expect(defaults.versions.nodeTools['@biomejs/biome']).toBe('2.4.4');
    expect(Object.keys(defaults.versions.systemTools).length).toBe(67);

...
<script module lang="ts">
  /**
   * Indicator Svelte component — small badge or dot positioned
   * at the corner of another element to show status, count, or
   * notification. Placeholder shell awaiting full
  ...
  /** Public component props for Indicator. */

...
<script module lang="ts">
  /**
   * ResizeObserver Svelte component — wrapper that observes
   * its element's dimensions via ResizeObserver and exposes
   * width/height changes to consumers. Placeholder shell
  ...
  /** Public component props for ResizeObserver. */

...
<script module lang="ts">
  /**
   * EmailTemplate Svelte component — email template editor /
   * viewer for transactional and marketing messages. Placeholder
  ...
  /** Public component props for EmailTemplate. */

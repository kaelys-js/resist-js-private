...
<script module lang="ts">
  /**
   * UploadProgress Svelte component — multi-file upload list
   * with per-file progress bars and status. Placeholder shell
  ...
  /** Public component props for UploadProgress. */

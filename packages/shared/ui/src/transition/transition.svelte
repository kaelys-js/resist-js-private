...
<script module lang="ts">
  /**
   * Transition Svelte component — wrapper that applies
   * enter / exit animations to its children when they mount,
   * unmount, or change state. Placeholder shell awaiting full
  ...
  /** Public component props for Transition. */

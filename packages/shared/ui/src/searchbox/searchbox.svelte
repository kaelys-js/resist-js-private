...
<script module lang="ts">
  /**
   * Searchbox Svelte component — text input optimized for
   * search, with clear button and optional inline
   * suggestions. Placeholder shell awaiting full
  ...
  /** Public component props for Searchbox. */

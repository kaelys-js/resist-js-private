...
<script module lang="ts">
  /**
   * LollipopChart Svelte component — bar-chart variant where
   * each bar is a thin line topped with a circle. Placeholder
  ...
  /** Public component props for LollipopChart. */

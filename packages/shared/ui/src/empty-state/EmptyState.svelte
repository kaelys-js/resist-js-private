...
<script module lang="ts">
  /**
   * EmptyState Svelte component — high-level empty-state
   * placeholder showing illustration, message, and a primary CTA
   * button. Placeholder shell awaiting full implementation; ships
  ...
  /** Public component props for EmptyState. */

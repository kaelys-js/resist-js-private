...
<script module lang="ts">
  /**
   * PermissionMatrix Svelte component — admin role / permission
   * grid. Placeholder shell awaiting full implementation; ships
  ...
  /** Public component props for PermissionMatrix. */

...
<script module lang="ts">
  /**
   * CoolMode — particle burst that emits on click for celebratory
   * UI feedback. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for CoolMode. */

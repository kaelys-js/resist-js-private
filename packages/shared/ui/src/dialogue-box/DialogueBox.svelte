...
<script module lang="ts">
  /**
   * DialogueBox — RPG-style game dialogue box with typewriter
   * text. Placeholder shell awaiting full implementation; ships
  ...
  /** Public component props for DialogueBox. */

...
<script module lang="ts">
  /**
   * ImageZoom Svelte component — magnify-on-hover loupe over an
   * image. Placeholder shell awaiting full implementation; ships
  ...
  /** Public component props for ImageZoom. */

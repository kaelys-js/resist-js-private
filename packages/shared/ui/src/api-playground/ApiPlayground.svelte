...
<script module lang="ts">
  /**
   * ApiPlayground — interactive request builder for testing API
   * endpoints. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for ApiPlayground. */

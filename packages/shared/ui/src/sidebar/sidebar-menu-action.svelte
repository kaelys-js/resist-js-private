<script lang="ts">
  ...
  const mergedProps = $derived({
    class: cn(
      ...
      showOnHover &&
        'peer-data-[active=true]/menu-button:text-sidebar-accent-foreground group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 md:opacity-0 transition-opacity duration-200',
      className,
    ),

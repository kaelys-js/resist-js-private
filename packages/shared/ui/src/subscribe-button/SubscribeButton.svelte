...
<script module lang="ts">
  /**
   * SubscribeButton Svelte component — toggle button for
   * subscribing/unsubscribing to a channel, newsletter, or
   * feed. Placeholder shell awaiting full implementation;

...
<script module lang="ts">
  /**
   * BottomNavigationBar — fixed bottom bar with navigation icons,
   * commonly used in mobile layouts. Placeholder shell awaiting
  ...
  /** Public component props for BottomNavigationBar. */

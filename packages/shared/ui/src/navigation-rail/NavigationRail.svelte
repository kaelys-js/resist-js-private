...
<script module lang="ts">
  /**
   * NavigationRail Svelte component — Material-style narrow
   * vertical navigation rail. Placeholder shell awaiting full
  ...
  /** Public component props for NavigationRail. */

...
<script module lang="ts">
  /**
   * RichTextEditor Svelte component — WYSIWYG editor for
   * formatted text with toolbars, slash commands, and
   * collaborative features. Placeholder shell awaiting full
  ...
  /** Public component props for RichTextEditor. */

...
<script module lang="ts">
  /**
   * RecentlyViewed Svelte component — horizontally scrolling
   * strip showing products or pages the user has recently
   * visited. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for RecentlyViewed. */

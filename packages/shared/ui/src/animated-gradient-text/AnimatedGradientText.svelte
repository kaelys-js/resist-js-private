...
<script module lang="ts">
  /**
   * AnimatedGradientText — text rendered with a colorful animated
   * gradient fill. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for AnimatedGradientText. */

...
<script module lang="ts">
  /**
   * Snippet Svelte component — styled inline container for
   * short code or text snippets, with a copy-to-clipboard
   * button. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for Snippet. */

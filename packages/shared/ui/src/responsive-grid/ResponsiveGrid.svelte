...
<script module lang="ts">
  /**
   * ResponsiveGrid Svelte component — CSS grid wrapper that
   * adjusts column count at common breakpoints to keep tiles
   * legible across screen sizes. Placeholder shell awaiting

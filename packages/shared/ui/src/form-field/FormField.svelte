...
<script module lang="ts">
  /**
   * FormField Svelte component — wrapper that associates a
   * label, help text, and validation error message with a form
   * input. Placeholder shell awaiting full implementation;

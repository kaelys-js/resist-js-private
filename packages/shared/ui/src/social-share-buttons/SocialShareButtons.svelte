...
<script module lang="ts">
  /**
   * SocialShareButtons Svelte component — inline row of
   * branded share-to-platform icon buttons. Placeholder shell
  ...
  /** Public component props for SocialShareButtons. */

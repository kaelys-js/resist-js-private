...
<script module lang="ts">
  /**
   * VirtualScroller Svelte component — list virtualisation
   * wrapper that only renders items inside the viewport for
   * smooth scrolling of large datasets. Placeholder shell
  ...
  /** Public component props for VirtualScroller. */

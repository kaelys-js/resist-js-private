...
<script module lang="ts">
  /**
   * ZStack Svelte component — overlay-stacking container
   * that places its children at the same coordinates with
   * configurable z-order. Placeholder shell awaiting full
  ...
  /** Public component props for ZStack. */

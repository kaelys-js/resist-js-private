...
<script module lang="ts">
  /**
   * ReleaseNotes Svelte component — chronological list of
   * versioned release notes with section headings per
   * version. Placeholder shell awaiting full implementation;
  ...
  /** Public component props for ReleaseNotes. */

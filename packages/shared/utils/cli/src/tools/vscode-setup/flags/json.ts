/**
 * VS Code Setup Tool — JSON Flag
 *
 * `--json`: Output results in JSON format for scripting and CI integration.
 * Suppresses human-readable output and emits a single JSON object to stdout.
 *
 * @module
 */

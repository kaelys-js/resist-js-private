/**
 * Tests for getBuildInfo — build-time metadata accessor.
 *
 * @module
 */
...
describe('getBuildInfo', () => {
  ...
  it('returns err when define constants are undefined', () => {
    // Save originals
    const origVersion = globalThis.__APP_VERSION__;
    ...
    try {
      ...
      globalThis.__APP_VERSION__ = origVersion;
      globalThis.__GIT_COMMIT__ = origCommit;
    }
  });

...
#   check, lint
# ------------------------------------------------------------------------------
ported::images_webp_not_used_for_icons() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_hidden_interactive() {
...
#   lint, check, build
# ------------------------------------------------------------------------------
ported::images_svg_symbol_missing_viewbox() {
...
#   check, lint
# ------------------------------------------------------------------------------
ported::images_svg_opacity_fallback() {
...
#   check, build
# ------------------------------------------------------------------------------
ported::images_svg_blur_filter_detected() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_aria_roles_defined() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_text_overflow_clipped() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_title_first_child() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_tabindex_removed() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_webp_in_css_url_blocked() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_mask_url_fragment() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_non_decorative_missing_aria() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_title_desc_missing_lang() {
...
#   lint, check
# ------------------------------------------------------------------------------
ported::images_svg_inlined_should_use_component() {

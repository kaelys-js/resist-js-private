...
# ------------------------------------------------------------------------------
# 🧪 ported::detached_head_state — Warn if CI is running in detached HEAD
# ------------------------------------------------------------------------------
# This function performs validation such as:
...
# ------------------------------------------------------------------------------
# 🧪 ported::disallow_non_fast_forward_on_main — Prevent unsafe merge history on main
# ------------------------------------------------------------------------------
...
#
# Example:
#   ported::disallow_non_fast_forward_on_main
#
# Categories:
#   safety, ci, git
#
...
# ------------------------------------------------------------------------------
# 🧪 ported::disallow_merge_commits_on_main — Enforce linear history on main branch
# ------------------------------------------------------------------------------
...
#
# Example:
#   ported::disallow_merge_commits_on_main
#
# Categories:
#   git, lint, ci
#
...
# ------------------------------------------------------------------------------
# 🧪 ported::enforce_branch_naming_convention — Require standard branch prefixes
# ------------------------------------------------------------------------------
...
#
# Example:
#   ported::enforce_branch_naming_convention
#
# Categories:
#   ci, naming, lint
#
...
# ------------------------------------------------------------------------------
# 🧪 ported::validate_conventional_commits — Enforce Conventional Commits format
# ------------------------------------------------------------------------------
# This function performs validation such as:
...
#
# Example:
#   ported::validate_conventional_commits
#
# Categories:
#   lint, ci
#
...
# ------------------------------------------------------------------------------
# 🧪 ported::git_rebase_in_progress — Warn if Git is in a mid-rebase state
# ------------------------------------------------------------------------------
# This function performs validation such as:
...
# ------------------------------------------------------------------------------
# 🧪 ported::git_sparse_checkout_consistency — Detect unintended sparse-checkout state
# ------------------------------------------------------------------------------
# This function performs validation such as:
...
#
# Example:
#   ported::git_sparse_checkout_consistency
#
# Categories:
#   ci, paths
#
...
# ------------------------------------------------------------------------------
# 🧪 ported::git_config_enforced — Ensure Git config settings match policy
# ------------------------------------------------------------------------------
# This function performs validation such as:
...
# ------------------------------------------------------------------------------
# 🧪 ported::git_index_lock_orphans — Detect orphaned index.lock files
# ------------------------------------------------------------------------------
# This function performs validation such as:

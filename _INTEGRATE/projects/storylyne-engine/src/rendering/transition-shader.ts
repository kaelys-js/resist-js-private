 ...
 *
 * The actual key in `ShadersStore` is `'storylyneTransitionFragmentShader'`.
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export const TRANSITION_SHADER_NAME = 'storylyneTransition';
 ...
 * // Shader is now available as 'storylyneTransition' in Effect.ShadersStore
 * ```
 */
